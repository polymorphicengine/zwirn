...
--   where
--     oneDec name = ValD (VarP (mkName name)) (NormalB (AppE (VarE '_chordMaker) (LitE (StringL name)))) []
...
--   where
--     oneDec name = ValD (VarP (mkName name)) (NormalB (AppE (VarE '_noteVal) (LitE (StringL name)))) []
