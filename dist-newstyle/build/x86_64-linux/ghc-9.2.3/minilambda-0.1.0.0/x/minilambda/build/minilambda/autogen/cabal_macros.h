...
/* package minilambda-0.1.0.0 */
#ifndef VERSION_minilambda
#define VERSION_minilambda "0.1.0.0"
#endif /* VERSION_minilambda */
#ifndef MIN_VERSION_minilambda
#define MIN_VERSION_minilambda(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_minilambda */
...
#define CURRENT_COMPONENT_ID "minilambda-0.1.0.0-inplace-minilambda"
